...
public class FiremakingCalc extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    public int normalLog = 40;
    public int oakLog = 60;
    public int willowLog = 90;
    public int teakLog = 105;
    public int mapleLog = 135;
    public int mahoganyLog = 157;
    public int yewLog = 202;
    public int blisterwoodLog = 96;
    public int magicLog = 303;
    public int redwoodLog = 350;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firemaking_calc);

        Spinner spinner = findViewById(R.id.spinner_burnLogs);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.burnLogs, android.R.layout.simple_spinner_item);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        TextView levelStart1 = findViewById(R.id.startLevel2);
        TextView levelEnd1 = findViewById(R.id.desiredLevel2);
